...
interface WatchRepository {
    ...
    suspend fun updateHistory(animeId: Long, episodeNumber: Int, progress: Long, duration: Long, completed: Boolean): Result<Unit>
...
interface CommentRepository {
    ...
    suspend fun addComment(animeId: Long, content: String, episodeNumber: Int?): Result<Comment>
    suspend fun deleteComment(id: Long): Result<Unit>
}

interface ProfileRepository {
    suspend fun getProfile(): Result<UserProfile>
    suspend fun updateProfile(bio: String?, avatar: String?): Result<User>
